...
//        if (Float.isNaN(score.scoreBrakes) || Float.isInfinite(score.scoreBrakes))
//            score.scoreBrakes = 100;
...
//
//        Float doubleScore = (score.scoreBrakes / 4 + score.scoreAccels / 4 + score.scoreTurns / 4 + score.scoreLaneChanges / 4);
...
//            score.scoreBrakes += pattern.score;
//        score.scoreBrakes /= brakes.size();
//
